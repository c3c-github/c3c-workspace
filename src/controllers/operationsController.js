...
exports.getTickets = async (req, res) => {
    try {
        ...
        // PASSO 1: Definir o escopo de Contas permitidas (Apenas com Alocacao Vigente em Serviço de Suporte)
        const soqlAlocScope = `SELECT Servico__r.Conta__c FROM Alocacao__c WHERE Pessoa__c = '${userId}' AND Servico__r.Tipo__c = 'Suporte' AND DataInicio__c <= ${today} AND (DataFimOriginal__c >= ${today} OR DataFimOriginal__c = NULL)`;
